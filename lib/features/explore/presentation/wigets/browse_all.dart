...
class BrowseAllGrid extends ConsumerWidget {
  const BrowseAllGrid({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final browseAllUiProvider = ref.watch(browseAllProvider);
    return browseAllUiProvider.when(
  ...
  Widget dataBuilder(List<TopGenres> value){
   return GridView.builder(
      ...
      itemBuilder: (context, index){
        return InkWell(
          onTap: () {
            //TODO: Add function to each grid in the browse all grid
          },
          child: Container( 
